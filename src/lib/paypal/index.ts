...
export const getAccessToken = async () => {
  ...
  const res = await fetch(`${PAYPAL_API_URL_TEST}/v1/oauth2/token`, {
    method: "POST",
    headers: {
...
export const createSubscription = async (profile: Profile, planId: string) => {
  ...
  const res = await fetch(`${PAYPAL_API_URL_TEST}/v1/billing/subscriptions`, {
    method: "POST",
    headers: {
...
export const retrieveSubscription = async (subscriptionId: string) => {
  ...
  const res = await fetch(
    `${PAYPAL_API_URL_TEST}/v1/billing/subscriptions/${subscriptionId}`,
    {
      headers: {
        Authorization: `Bearer ${accessToken}`,
        "Content-Type": "application/json",
...
export const suspendSubscription = async (subscriptionId: string) => {
  const accessToken = await getAccessToken();
  const res = await fetch(
    `${PAYPAL_API_URL_TEST}/v1/billing/subscriptions/${subscriptionId}/suspend`,
    {
      method: "POST",
      headers: {
        Authorization: `Bearer ${accessToken}`,
...
export const cancelSubscription = async (subscriptionId: string) => {
  ...
  const res = await fetch(
    `${PAYPAL_API_URL_TEST}/v1/billing/subscriptions/${subscriptionId}/cancel`,
    {
      method: "POST",
      headers: {
        Authorization: `Bearer ${accessToken}`,
...
export const updateSubscription = async (
  ...
  const res = await fetch(
    `${PAYPAL_API_URL_TEST}/v1/billing/subscriptions/${subscriptionId}/revise`,
    {
      method: "POST",
      headers: {
        Authorization: `Bearer ${accessToken}`,
